...
const MainFrame = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="w-full bg-neutral-four h-screen overflow-auto text-text p-4 md:flex hidden"><div class="w-[200px] min-w-[200px] space-y-2 flex flex-col pb-4"><button${add_attribute("class", `flex w-full  p-3 pr-4 pl-4 rounded-xl font-medium hover:bg-neutral-two ${getActiveTabClasses("/website")}`, 0)}>${validate_component(Home, "HomeIcon").$$render($$result, { class: "h-6 w-6" }, {}, {})} <div class="ml-4" data-svelte-h="svelte-1y52hpw">Home</div></button> <button${add_attribute("class", `flex w-full  p-3 pr-4 pl-4 rounded-xl font-medium hover:bg-neutral-two ${getActiveTabClasses("/website/projects")}`, 0)}>${validate_component(Package, "PackageIcon").$$render($$result, { class: "h-6 w-6" }, {}, {})} <div class="ml-4" data-svelte-h="svelte-hejwix">Projects</div></button> <button${add_attribute("class", `flex w-full p-3 pr-4 pl-4 rounded-xl font-medium hover:bg-neutral-two ${getActiveTabClasses("/website/team")}`, 0)}>${validate_component(People, "TeamIcon").$$render($$result, { class: "h-6 w-6" }, {}, {})} <div class="ml-4" data-svelte-h="svelte-1xn3quu">Team</div></button> <div class="flex-grow"></div> <div class="p-2 bg-neutral-two rounded-lg">${validate_component(Logo_extended, "WhiskersAppsExtendedLogo").$$render($$result, { class: "h-12 w-full" }, {}, {})}</div></div> <div class="flex-grow bg-neutral-two ml-4 rounded-xl border border-neutral-six p-16 flex flex-col overflow-auto">${slots.default ? slots.default({}) : ``}</div></div> <div class="flex flex-col md:hidden bg-neutral-two h-screen overflow-auto text-text"><div class="flex-grow p-4 overflow-auto">${slots.default ? slots.default({}) : ``}</div> <div class="flex bg-neutral-four p-2"><button${add_attribute("class", `flex flex-col items-center w-full  p-3 pr-4 pl-4 rounded-xl font-medium hover:bg-neutral-two ${getActiveTabClasses("/website")}`, 0)}>${validate_component(Home, "HomeIcon").$$render($$result, { class: "h-6 w-6" }, {}, {})} <div class="text-xs" data-svelte-h="svelte-hrelrd">Home</div></button> <button${add_attribute("class", `flex flex-col items-center w-full  p-3 pr-4 pl-4 rounded-xl font-medium hover:bg-neutral-two ${getActiveTabClasses("/website/projects")}`, 0)}>${validate_component(Package, "PackageIcon").$$render($$result, { class: "h-6 w-6" }, {}, {})} <div data-svelte-h="svelte-1rxt3xs">Projects</div></button> <button${add_attribute("class", `flex flex-col items-center w-full p-3  rounded-xl font-medium hover:bg-neutral-two ${getActiveTabClasses("/website/team")}`, 0)}>${validate_component(People, "TeamIcon").$$render($$result, { class: "h-6 w-6" }, {}, {})} <div class="text-xs" data-svelte-h="svelte-214xqj">Team</div></button></div></div>`;
});
export {
  MainFrame as M,
  Package as P,
